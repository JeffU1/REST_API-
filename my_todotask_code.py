...
def init_todo_db():
    ...
    VALUES
        ("Project 2", "We work on project 2 with teammates", 1 ),
        ("Cloudformation Documentation", "I study and learn how to read cloudformation docs", 0),
...
@app.route('/')
def home():
    return "Welcome to Cem's To-Do API Service"
